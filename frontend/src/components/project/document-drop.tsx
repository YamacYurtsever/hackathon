  ...
  return (
    ...
    >
      ...
      {armed && (
        ...
        <div className="bg-background/80 pointer-events-none absolute inset-0 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
          <div className="border-primary flex h-full w-full flex-col items-center justify-center gap-1 rounded-xl border-2 border-dashed">
            <p className="text-lg font-medium">Drop to read into this project</p>
